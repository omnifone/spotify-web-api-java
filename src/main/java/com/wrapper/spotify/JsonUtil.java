...
public class JsonUtil {
     ...
     *
     * @param copyrightsJson A JSON array containing copyright information
    ...
    private static Page createItemlessPage(JSONObject pageJson) {
        ...
        if (existsAndNotNull("href", pageJson)) {
            page.setHref(pageJson.getString("href"));
        }
        
        if (existsAndNotNull("limit", pageJson)) {
    ...
    public static Playlist createPlaylist(JSONObject jsonObject) {
        ...
        if (existsAndNotNull("snapshot_id", jsonObject)) {
